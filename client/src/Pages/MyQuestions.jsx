...
import { myQuestions } from "../Routes/routes";
...
const MyQuestions = () => {
    ...
    const fetchQuestions = async () => {
        try {
            let response = await axios.get(myQuestions + "/" + sessionStorage.getItem('id'));
    ...
    return (
        <>
            ...
            <div className="flexBoxQuestions">
                {data.map((question) => {
                    return (
                        <Question className="flexelemQuestion" data={question} loggedIn={loggedIn} key={question.id} />
                    )
